...
<body>
    ...
    <section>
        <button type="button" class="button blue mobile" onclick="openCadastro()" id="open-cadastro">Cadastrar Marca</button>
        ...
        <div class="modal" id="cadastro">
            <div class="modal-content">
                ...
                <form id="formCadastro" class="modal-form">
                    <input type="text" id="nome_marca" name="nome_marca" class="modal-field" placeholder="Nome da Marca" required>
                </form>
        ...
        <div class="modal" id="edit">
            <div class="modal-content">
                ...
                <form id="formEdit" class="modal-form">
                    ...
                    <input type="text" id="nome_edit" name="nome_marca" class="modal-field" placeholder="Nome da Marca" required>
                </form>
